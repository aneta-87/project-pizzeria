...
/* eslint-disable */
{
  ...
  class Cart {
    ...
    add(menuProduct) {
      ...
      thisCart.products.push(new CartProduct(menuProduct, generatedDOM)); //dzięki temu będziemy mieli stały dostęp do instancji wszystkich produktów
      /*console.log('thisCart.products: ', thisCart.products); //Efektem jest wyświetlana w konsoli (w momencie dodania do koszyka) instancja klasy CartProduct*/
    }
    update() { //new method
      const thisCart = this;
